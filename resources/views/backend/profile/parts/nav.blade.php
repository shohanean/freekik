...
<div class="card mb-5 mb-xl-10">
    <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            @isset(auth()->user()->email_verified_at)
                                ...
                                <!--end::Svg Icon-->
                                <a href="#" class="btn btn-sm btn-light-success fw-bolder ms-2 fs-8 py-1 px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Email Verified</a>
                            @endisset
                        </div>
                        <!--end::Name-->
                        <!--begin::Info-->
        ...
        <!--end::Details-->
        <!--begin::Navs-->
        <ul wire:ignore class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ (Request::route()->getName() == 'profile.index' ? 'active': '') }}" href="{{ route('profile.index') }}">Overview</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ (Request::route()->getName() == 'profile.edit' ? 'active': '') }}" href="{{ route('profile.edit', auth()->id()) }}">Edit</a>
            </li>
            <!--end::Nav item-->
            <!--begin::Nav item-->
            <li class="nav-item mt-2">
