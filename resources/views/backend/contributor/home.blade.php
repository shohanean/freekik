...
@section('content')
    <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
        ...
        <div class="col-xl-3">
            <!--begin::Card widget 3-->
            <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
                style="background-color: #80f4b0">
                <!--begin::Header-->
                <div class="card-header pt-5 mb-3">
                    <!--begin::Icon-->
                    <div class="d-flex flex-center rounded-circle h-80px w-80px"
                        style="border: 1px dashed rgba(0, 0, 0, 0.4);background-color: #80f4b0">
        ...
        <div class="col-xl-3">
            <!--begin::Card widget 3-->
            <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
                style="background-color: #eaf761">
                <!--begin::Header-->
                <div class="card-header pt-5 mb-3">
                    <!--begin::Icon-->
                    <div class="d-flex flex-center rounded-circle h-80px w-80px"
                        style="border: 1px dashed rgba(0, 0, 0, 0.4);background-color: #eaf761">
        ...
        <div class="col-xl-3">
            <!--begin::Card widget 3-->
            <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
                style="background-color: #fd884e">
                <!--begin::Header-->
                <div class="card-header pt-5 mb-3">
                    <!--begin::Icon-->
                    <div class="d-flex flex-center rounded-circle h-80px w-80px"
                        style="border: 1px dashed rgba(0, 0, 0, 0.4);background-color: #fd884e">
        ...
        <div class="col-xl-3">
            ...
            <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
                ...
                <div class="card-header pt-5 mb-3">
                    <!--begin::Icon-->
                    <div class="d-flex flex-center rounded-circle h-80px w-80px"
                        style="border: 1px dashed rgba(250, 245, 245, 0.4);background-color: #565555">
        ...
        <div class="col-xl-3">
            <!--begin::Card widget 3-->
            <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
                style="background-color: #fd4e4e">
                <!--begin::Header-->
                <div class="card-header pt-5 mb-3">
                    <!--begin::Icon-->
                    <div class="d-flex flex-center rounded-circle h-80px w-80px"
                        style="border: 1px dashed rgba(0, 0, 0, 0.4);background-color: #fd4e4e">
        ...
        <div class="col-xl-3">
            <!--begin::Card widget 3-->
            <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
                style="background-color: #548c82">
                <!--begin::Header-->
                <div class="card-header pt-5 mb-3">
                    <!--begin::Icon-->
                    <div class="d-flex flex-center rounded-circle h-80px w-80px"
                        style="border: 1px dashed rgba(0, 0, 0, 0.4);background-color: #548c82">
        ...
        <div class="col-xl-3">
            <!--begin::Card widget 3-->
            <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
                style="background-color: #4efddd">
                <!--begin::Header-->
                <div class="card-header pt-5 mb-3">
                    <!--begin::Icon-->
                    <div class="d-flex flex-center rounded-circle h-80px w-80px"
                        style="border: 1px dashed rgba(0, 0, 0, 0.4);background-color: #4efddd">
                            ...
                            <tbody>
                                @forelse ($tops as $top)
                                    <tr class="border-bottom align-middle">
                                        <td>
                                            @if ($loop->index == 0)
                                                <img src="{{ asset('dashboard_assets/media/badges/1.png') }}"
                                                    alt="not found" width="40">
                                            @elseif ($loop->index == 1)
                                                <img src="{{ asset('dashboard_assets/media/badges/2.png') }}"
                                                    alt="not found" width="40">
                                            @else
                                                <img src="{{ asset('dashboard_assets/media/badges/3.png') }}"
                                                    alt="not found" width="40">
                                            @endif
                                        </td>
                                        <td>
                                            <a href="{{ route('item.details', App\Models\File::find($top->file_id)->slug) }}"
                                                target="_blank">{{ App\Models\File::find($top->file_id)->title }}</a>
                                        </td>
                                        <td>{{ $top->total }}</td>
...
@section('footer_scripts')
    <script>
        const ctx = document.getElementById('hudai');
        ...
        const ctx1 = document.getElementById('hudai1');
