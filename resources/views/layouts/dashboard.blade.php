...
<body id="kt_body"
                ...
                <div class="aside-menu flex-column-fluid">
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            @endcanany
                            @can('can manage category manager')
                                <div class="menu-item">
                            ...
                            @can('reviewer access')
                                <div class="menu-item">
                                    <div class="menu-content pt-8 pb-2">
                                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Review
                                            Section</span>
                                    </div>
                                </div>
                                <div class="menu-item">
                            ...
                            @can('contributor access')
                                <div class="menu-item">
                                    <div class="menu-content pt-8 pb-2">
                                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Upload
                                            Section</span>
                                    </div>
                                </div>
                                <div class="menu-item">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link @yield('earnings.index')" href="{{ route('earnings.index') }}">
                                        <span class="menu-icon">
                            ...
                            @can('can take backup')
                                <div class="menu-item">
                                    <div class="menu-content pt-8 pb-2">
                                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">System
                                            Settings</span>
                                    </div>
                                </div>
                                <div class="menu-item">
                                    ...
                                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                                        ...
                                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                                            ...
                                            <span class="menu-link py-3">
                                                <span
                                                    class="menu-title">{{ auth()->user()->roles->first()->name }}</span>
    ...
    <div class="engage-toolbar d-flex position-fixed px-5 fw-bolder zindex-2 top-50 end-0 transform-90 mt-20 gap-2">
        ...
        <a href="{{ route('upload.create') }}"
            class="engage-purchase-link btn btn-color-gray-700 bg-body btn-active-color-gray-900' btn-flex h-35px px-5 shadow-sm rounded-top-0">Upload
            Files</a>
        <!--end::Purchase link-->
    </div>
    <!--end::Engage toolbar-->
    ...
    <!--begin::Page 3rd Party Javascript-->
