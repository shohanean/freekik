...
<body>
    <nav class="navbar position-fixed navbar-expand-lg py-1" id="navbar" aria-label="Main navigation">
        <div class="container">
            <a class="navbar-brand fw-semibold text-dark d-flex fs-3 align-items-center" href="{{ route('index') }}"><i
                    class="fa-brands fa-connectdevelop pe-2 fs-1" style="color: dark;"></i>FreeKik</a>
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <div class="navbar-collapse container">
                        ...
                        @foreach (categories()->take(3) as $c)
                            <li class="nav-item">
                                <a class="nav-link text-dark"
                                    href="{{ route('category.details', $c->slug) }}">{{ $c->name }}</a>
                            </li>
                        @endforeach
                    ...
                    <div class="d-flex flex-column flex-md-row align-items-md-center ms-auto">
                        @auth
                            <a href="{{ route('upload.create') }}" class="text-dark me-4 text-decoration-none"><i
                                    class="fa fa-upload"></i> Upload Your File</a>
                        @endauth
                        {{-- <a href="" class="text-dark me-4 text-decoration-none">Pricing</a> --}}
                        {{-- <p class="mb-0">
                            <a href="" class="text-dark me-4 text-decoration-none fw-semibold" id="login">Log in</a>
                            <a href="register.html" class="text-dark me-4 text-decoration-none fw-semibold">Sign up</a>
                        </p> --}}
                        ...
                        @guest
                            <div class="btn-group">
                                <button type="button" class="text-dark border-0 bg-transparent dropdown-toggle"
                                ...
                                <ul class="dropdown-menu dropdown-menu-lg-end p-3">
                                    <div class="d-flex align-items-center">
                                        <div class="info_user">
                                            <a href="{{ route('login') }}"
                                                class="btn btn-primary fw-light mt-2">Login/Register</a>
                                        </div>
                                    </div>
                                </ul>
                            </div>
                            ...
                            <div class="btn-group">
                                <button type="button" class="text-dark border-0 bg-transparent dropdown-toggle"
                                    ...
                                    <img src="{{ auth()->user()->avatar ? asset(auth()->user()->avatar) : Avatar::create(auth()->user()->name)->toBase64() }}"
                                        alt="not found" style="width: 30px; height: 30px;">
                                </button>
                                <ul class="dropdown-menu dropdown-menu-lg-end p-3">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ auth()->user()->avatar ? asset(auth()->user()->avatar) : Avatar::create(auth()->user()->name)->toBase64() }}"
                                            alt="not found" style="width: 70px; height: 70px;">
                                        <div class="info_user ps-3">
                                            <a href=""
                                                class="text-secondary text-decoration-none">{{ auth()->user()->name }}</a>
                                            <a href=""
                                                class="text-secondary fw-light text-decoration-none">{{ auth()->user()->email }}</a>
                                            <a href="{{ route('profile.index') }}"
                                                class="btn btn-primary fw-light mt-2">Edit Profile</a>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <a href="{{ route('home') }}" class="text-decoration-none text-dark">
                                        <li class="d-flex align-items-center fw-lighter my-2">
                                            ...
                                            <button class="border-0 bg-transparent ps-2 fw-light fs-6"
                                    ...
                                    <a href="{{ route('your.downloads') }}" class="text-decoration-none text-dark">
                                        <li class="d-flex align-items-center fw-lighter my-2">
                                            ...
                                            <button class="border-0 bg-transparent ps-2 fw-light fs-6" type="button">Your
                                                Downloads</button>
                                        </li>
                                    </a>
                                ...
                                <li class="d-flex align-items-center my-2"><i
                                    ...
                                    <li class="d-flex align-items-center my-2">
                                        ...
                                        <button
                                            ...
                                            class="border-0 bg-transparent ps-2 text-danger" type="button"><i
    ...
    <footer class="py-5 mt-5" style="background-color: #1d262d;">
        <div class="container">
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
                <div class="col col-lg-3 text-center text-md-start mb-3 mb-lg-0">
                ...
                <div class="col col-lg-2 text-center text-md-start mb-3 mb-lg-0">
                ...
                <div class="col col-lg-3 text-center text-md-start mb-3 mb-lg-0">
                    ...
                    <div class="d-flex justify-content-center justify-content-md-start footer-social mt-4">
                        <a href="" class=""><i
                                class="fa-brands fa-facebook text-white text-center fs-5 me-2"
                                style="background-color:#4267B2;"></i></a>
                        <a href="" class=""><i
                                class="fa-brands fa-twitter text-white text-center fs-5 me-2"
                                style="background-color: #00acee;"></i></a>
                        <a href="" class=""><i
                                class="fa-brands fa-pinterest text-white text-center fs-5 me-2"
                                style="background-color:#E60023;"></i></a>
                        <a href="" class=""><i
                                class="fa-brands fa-instagram text-white text-center fs-5 me-2"
                                style="background: linear-gradient(29.61deg, #f38334 0%, #da2e7d 50.39%, #6b54c6 100%);"></i></a>
                        <a href="" class=""><i
                                class="fa-brands fa-youtube text-white text-center fs-5 me-2"
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-5 d-flex align-items-center">
                    <p class="web-footer-color m-0">Copyright © {{ \Carbon\Carbon::now()->format("Y") }} Creset. All rights reserved.</p>
                </div>
                {{-- <div class="col-sm-12 col-md-12 col-lg-4 d-flex align-items-center">
                    <div class="dropdown ms-auto">
                        <a class="btn btn-secondary dropdown-toggle bg-transparent shadow-none"
                            style="border: 3px solid dark;" href="#" role="button" id="dropdownMenuLink"
                ...
                {{-- <a class="mt-4" target="_blank" href="https://www.sslcommerz.com/" title="SSLCommerz"
                    alt="SSLCommerz"><img style="width:100%;height:auto;"
